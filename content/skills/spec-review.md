...
Also prefer the draft's `## Reviewer Brief`, `## Traceability Matrix`, and `## Reference Discipline` as scope-control evidence: review listed blockers and invariants first, and treat unrelated deeper-layer suggestions as advisory unless they expose critical/security risk.
